...
function show()
{
  ...
  if (!$db){
    ...
    if (isset($_GET['id'])) {
      $id = $_GET['id'];
      $results = $db->query("SELECT * FROM jobs where id=$id") or onError($db, "No Record found");
    }
  }
  ?>
  ...
  <body>
    <main>
      ...
      <section class="g-py-100" id='jd'>
        ...
        // <input class="btn u-btn-primary rounded-3 g-py-12 g-px-20" style="float:right;" type="submit" name="back" value="Back" onclick="history.back()"/>
        $flg = 0;
        if ($results) {
          while ($line = $results->fetch_assoc()){
            ...
            <a href="careers.php" style="float:right;background-color:blue;color:white;" class="u-tags-v1 g-font-size-16 g-brd-around g-brd-gray-light-v3 g-bg-blue-v2--hover g color-white--hover rounded g-py-3 g-px-8">Back</a>
            ...
            echo '</div></div></div><div class="col-md-3 align-self-center text-md-right"><a id="apply_now" href="#modal';
            echo $flg;
            echo '" data-modal-target="#modal';
            echo $flg;
            echo '" data-modal-effect="fadein" class="u-tags-v1 g-font-size-16 g-color-main g-brd-around g-brd-gray-light-v3 g-bg-blue-v2--hover g color-white--hover rounded g-py-3 g-px-8">Apply Now</a>
            <div id="modal';
            echo $flg;
            echo '" class="modal-body1 text-left g-max-width-600 g-bg-gray-light-v5  g-overflow-y-auto g-pa-20" style="display: none;border:solid;">
              <button type="button" class="close" onclick="Custombox.modal.close();">
                <i class="hs-icon hs-icon-close"></i>
              </button>';
            echo '<form action="assets/php/apply_now.php" enctype="multipart/form-data" method="post" id="resume_mail">
              <div class="messages"></div>
                <div class="row">
                  <div class="col-md-6 form-group g-mb-20">
                    <label class="g-color-gray-dark-v2 g-font-size-13">First Name:</label>
                    <input class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" name="first_name" id="first_name" class="form-control" required>
                  </div>

                  <div class="col-md-6 form-group g-mb-20">
                    <label class="g-color-gray-dark-v2 g-font-size-13">Last Name:</label>
                    <input class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text"  name="last_name" id="last_name" class="form-control">
                  </div>

                  <div class="col-md-6 form-group g-mb-20">
                    <label class="g-color-gray-dark-v2 g-font-size-13">Email:</label>
                    <input class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="email"  name="email" id="email" class="form-control" required>
                  </div>

                  <div class="col-md-6 form-group g-mb-20">
                    <label class="g-color-gray-dark-v2 g-font-size-13">Phone:</label>
                    <input class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="tel" placeholder="8888888888" pattern="[1-9][0-9]{9}" name="phone" id="phone" class="form-control">
                  </div>

                  <div class="col-md-12 form-group g-mb-20">
                    <label class="g-color-gray-dark-v2 g-font-size-13">Upload Resume:</label>
                    <input class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="file" name="resume" id="resume" class="form-control" required>
                  </div>

                  <div class="col-md-12 form-group g-mb-40">
                    <label class="g-color-gray-dark-v2 g-font-size-13">Comments:</label>
                    <textarea class="form-control g-color-gray-dark-v5 g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus g-resize-none rounded-3 g-py-13 g-px-15" rows="7"  name="comments" id="comments" class="form-control"></textarea>
                  </div>
                  <input hidden id="job_title" name = "job_title" readonly value="';
                  echo $line["title"];
                  echo '"/><input hidden id="job_location" name = "job_location" readonly value="';
                  echo $line["location"];
                  echo '"/><input hidden id="jd" name = "jd" readonly value="';
                  echo $line["job_description"];
                  echo '"/><input hidden id="job_id" name = "job_id" readonly value="';
                  echo $_GET['id'];
                  echo '"/></div>
                <input class="btn u-btn-primary rounded-3 g-py-12 g-px-20" type="submit" name="submit" value="Submit"/>';
                echo '</form>
            </div></div></div>';
