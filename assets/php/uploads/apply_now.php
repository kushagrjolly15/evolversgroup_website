...
if(!empty($email) && !empty($fname)){
  if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
    ...
    if($uploadStatus == 1){
      ...
      // Recipient
      $toEmail = 'kjolly@evolversgroup.com';
      // Sender
      $from = 'noreply@evolversgroup.com';
      $fromName = 'Evolvers Group';

      // Subject
      $emailSubject = 'Application for Job Title '.$job_name .' at ' .$job_location . ' of ' . $fname;

      // Message
      $htmlContent = '<p>Hi Team,</p>
      <p>The following are the details of the potential candidate:</p>
      ...
      header("Location: ../../jobs-description.php");
      exit();
    }
  }
}
